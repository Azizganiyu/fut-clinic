...
class Student extends CI_Controller
{
    ...
    public function view()
    {
        ...
        $data['students'] = $this->student_model->get_all($order, $search);
        $data['title'] = 'Students';
        $data['page'] = 'Students';
    ...
    public function create()
    {
        ...
        $this->form_validation->set_rules('matric_num', 'Matric Number', 'required');
        $this->form_validation->set_rules('name', 'Name of Student', 'required');
        $this->form_validation->set_rules('email', 'Email', 'valid_email');
        $this->form_validation->set_rules('level', 'Level', 'numeric');
        ...
        {
            $db = $this->student_model->store($_POST);
            if($db)
            {
    ...
    public function edit($id)
    {
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            $data['title'] = 'Edit Student: '. $data['student']['student_id'];
            $data['page'] = 'edit_students';
            $this->load->view('template/header', $data);
            $this->load->view('navbar');
        ...
        {
            $db = $this->student_model->update($id, $_POST);
            if($db)
            {
            ...
            $data['student'] = $this->student_model->get_student($id);
            $data['title'] = 'Edit Student: '. $data['student']['name'];
            $data['page'] = 'edit_students';
            $this->load->view('template/header', $data);
            $this->load->view('navbar');
            $this->load->view('student_edit');
    ...
    {
        $this->student_model->destroy($this->input->post('id'));
    }
